      ...
      <Container className="terms">
        <div className="terms-left">
          ...
          <div className="terms-scroll">
            ...
            <p>
              <a href="#linksToOtherWebsites">Links to Other Websites</a>
            </p>
            <p>
            ...
            <p>
              <a href="#disclaimer">"AS IS" and "AS AVAILABLE" Disclaimer</a>
            </p>
            <p>
              <a href="#governingLaw">Governing Law</a>
            </p>
            <p>
              <a href="#disputesResolution">Disputes Resolution</a>
            </p>
            <p>
              <a href="#euUser">For European Union (EU) Users</a>
            </p>
            <p>
              <a href="#usLegalCompliance">United States Legal Compliance</a>
            </p>
            <p>
              <a href="#severabilityAndWaiver">Severability and Waiver</a>
            </p>
            <p>
              <a href="#translationInterpretation">
                Translation Interpretation
              </a>
            </p>
            <p>
              <a href="#changeTC">Changes to These Terms and Conditions</a>
            </p>
            <p>
          ...
          <div className="terms-scroll">
            ...
            <ul>
              ...
              <li>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Fat Cats,
                470/2, Pratap Gate, Kaithal.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to Fat Cats Official Website,
                accessible from{" "}
                <a href="https://www.fatcats.in" target="_blank">
                  https://www.fatcats.in
                </a>
              </li>
              <li>
            ...
            <h3 id="limitationOfLiability">Limitation of Liability</h3>
            <p>
            ...
            <h3 id="disclaimer">"AS IS" and "AS AVAILABLE" Disclaimer</h3>
            <p>
            ...
            <h3 id="governingLaw">Governing Law</h3>
            <p>
            ...
            <h3 id="disputesResolution">Disputes Resolution</h3>
            <p>
            ...
            <h3 id="euUser">For European Union (EU) Users</h3>
            <p>
            ...
            <h3 id="usLegalCompliance">United States Legal Compliance</h3>
            <p>
            ...
            <h3 id="translationInterpretation">Translation Interpretation</h3>
            <p>
            ...
            <h3 id="changeTC">Changes to These Terms and Conditions</h3>
            <p>
            ...
            <p>
              ...
              <a href="mailto:fatcats2025@gmail.com">fatcats2025@gmail.com</a>
            </p>
          </div>
        </div>
      </Container>
