      ...
      <Container className="terms">
        <div className="terms-left">
          ...
          <div className="terms-scroll">
            ...
            <p>
              <a href="#trackingTechnologiesAndCookies">
                Tracking Technologies and Cookies
              </a>
            </p>
            <p>
              <a href="#useOfYourPersonalData">Use of Your Personal Data</a>
            </p>
            <p>
              <a href="#retentionOfYourPersonalData">
                Retention of Your Personal Data
              </a>
            </p>
            <p>
              <a href="#transferOfYourPersonalData">
                Transfer of Your Personal Data
              </a>
            </p>
            <p>
              <a href="#deleteYourPersonalData">Delete Your Personal Data</a>
            </p>
            <p>
              <a href="#businessTransactions">Business Transactions</a>
            </p>
            <p>
              <a href="#lawEnforcement">Law enforcement</a>
            </p>
            <p>
              <a href="#otherLegalRequirements">Other legal requirements</a>
            </p>
            <p>
              <a href="#securityOfYourPersonalData">
            ...
            <p>
              <a href="#changesToThisPrivacyPolicy">
        ...
        <div className="terms-right">
          ...
          <div className="terms-scroll">
            ...
            <h3 id="useOfYourPersonalData">Use of Your Personal Data</h3>
            ...
            <h3 id="retentionOfYourPersonalData">
              Retention of Your Personal Data
            </h3>
            <p>
            ...
            <h3 id="transferOfYourPersonalData">
              Transfer of Your Personal Data
            </h3>
            <p>
            ...
            <h3 id="deleteYourPersonalData">Delete Your Personal Data</h3>
            <p>
            ...
            <h4 id="businessTransactions">- Business Transactions</h4>
            <p>
            ...
            <h3 id="securityOfYourPersonalData">
              Security of Your Personal Data
            </h3>
            <p>
            ...
            <h3 id="changesToThisPrivacyPolicy">
              Changes to this Privacy Policy
            </h3>
            <p>
